...
create table authors(authorid int,name varchar(255));
...
insert into authors(authorid,name) values (7, "Chetan Bhagat"),(8, "Vasdev Mohi"),(9,"Richard Powers");
...
create table Suppliers(supplier_id int auto_increment,supplier_name varchar(255),location varchar(255),primary key(supplier_id));
create table Products(product_id int auto_increment,product_name varchar(255) not null unique,description varchar(255),supplier_id int,primary key (product_id),foreign key(supplier_id) references Suppliers(supplier_id));
create table Stock(id int auto_increment,product_id int,balance_stock int, primary key(id),foreign key(product_id) references Products(product_id));

insert into Suppliers(supplier_name,location) values ("a001", "Mumbai"),("a002", "Surat"),("a003","Sangli"),("a004","Pune"),("a005","Amravati"),("a006","Banglore"),("a007","Delhi");
insert into Products(product_name,description,supplier_id) values ("BMW", "BMW Product",1),("AUDI","AUDI Product",2),("MG","MG Product",3),("KIA","KIA Product",4),("THAR","THAR Product",5);
insert into Stock(product_id,balance_stock) values (1, 28),(2,20),(3,30),(4,45),(5,35);
...
update emp set deptno=20 where deptno % 2=0;
update emp set deptno=30 where deptno % 3=0;
update emp set deptno=40 where deptno % 4=0;
update emp set deptno=50 where deptno % 5=0;
update emp set deptno=10 where not deptno % 2 = 0 and not deptno % 3 = 0 and not deptno % 4 = 0 and not deptno % 5 = 0;
...
create unique index empid using hash on employee(empid);
